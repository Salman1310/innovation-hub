      ...
      <AnimatePresence mode="wait">
        {open ? (
            ...
            >
              ...
              <div className="mb-2 flex items-center gap-2">
                <div
                  ...
                  style={{ background: "linear-gradient(135deg, #002855, #0E5665)" }}
                >
                  <Lightbulb className="h-3.5 w-3.5 text-[#FFCD00]" />
                </div>
                <span
                  className="text-xs font-bold uppercase tracking-[0.15em] text-[#002855]"
          ...
          <motion.button
            ...
            style={{
              background: "linear-gradient(135deg, #002855, #0E5665)",
              boxShadow: "0 10px 30px rgba(0,40,85,0.35)",
            }}
          >
            <Lightbulb className="h-5 w-5 text-[#FFCD00]" />
            {/* Ping animation */}
            <span className="absolute inset-0 rounded-full animate-ping opacity-25" style={{ background: "#002855" }} />
          </motion.button>
        ) : null}
      </AnimatePresence>
    </div>

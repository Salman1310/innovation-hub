    ...
    >
      <div
        ...
        style={{
          ...
          borderColor: isHighlighted ? "var(--sl-teal)" : "#DDE6E9",
        ...
        onMouseEnter={(e) => {
          ...
          el.style.borderColor = isHighlighted ? "var(--sl-teal)" : "#9BB5BC"
        }}
        onMouseLeave={(e) => {
          const el = e.currentTarget as HTMLDivElement
          el.style.boxShadow = "0 1px 3px rgba(14,56,70,0.06)"
          el.style.transform = "translateY(0)"
          el.style.borderColor = isHighlighted ? "var(--sl-teal)" : "#DDE6E9"
        }}
      >
        ...
        <div className="flex items-center gap-2 mt-2.5">
          <span className="text-[10px]" style={{ color: "#9BB5BC", fontFamily: "var(--font-body)" }}>
            {article.city}
          </span>

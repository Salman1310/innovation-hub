  ...
  return (
    <div className="flex flex-col h-screen" style={{ background: "var(--sl-cream)", color: "var(--sl-text)" }}>
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        {/* Globe panel */}
        <div
          className="w-1/2 flex flex-col items-center justify-center p-8 border-r"
          style={{ background: "linear-gradient(135deg, #EFF6F8 0%, #E0EEF1 100%)", borderColor: "#C9D8DC" }}
        >
          {focusedSourceId && (
        ...
        {/* Feed panel */}
        <div className="w-1/2 flex flex-col p-6 overflow-hidden" style={{ background: "var(--sl-cream)" }}>
          <NewsFeed
            articles={articles}
